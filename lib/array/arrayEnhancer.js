...
function enhance() {
    ...
    Array.prototype.remove = function (object) {
        return _arrayUtil2.default.remove(this, object);
    };
    Array.prototype.removeMatchProperties = function (properties) {
        return _arrayUtil2.default.removeMatchProperties(this, properties);
    };
    Array.prototype.removeIndexAt = function (index) {
        return _arrayUtil2.default.removeIndexAt(this, index);
    };
}
